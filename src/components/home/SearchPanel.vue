<template>
  <div class="bg-white rounded-t-3xl rounded-bl-3xl md:rounded-bl-2xl shadow-2xl p-4 md:p-8 md:px-14 w-full mx-auto max-w-6xl">
    <div class="flex flex-col md:flex-row md:justify-between w-full gap-4 md:gap-0">
      <!-- Title -->
      <h1 v-if="!hideTitle" class="text-h3 font-light text-others-gray1 md:text-h1-d">機票搜尋</h1>
