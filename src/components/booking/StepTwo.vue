<template>
  <div class="max-w-6xl w-full pt-20 md:pt-6 pb-6">
      <div class="grid grid-cols-12 gap-3">
          <div class="col-span-12 md:col-span-9 w-full items-center justify-between">
              <div class="relative mt-[0px] bg-white rounded-[10px] drop-shadow-[0px_2px_10px_rgba(0,0,0,0.05)] w-full">
                  <div v-if="!loading">
                      <div class="w-ful flex items-center gap-2 bg-white text-others-gray7 text-[17px] rounded-[10px] drop-shadow-[0px_2px_10px_rgba(0,0,0,0.05)] px-10 py-4 font-bold">
                          ...
                          <button
                              type="button"
                              class="ml-auto inline-flex md:hidden items-center gap-1 rounded-md border border-others-gray3 bg-white px-2 py-1 text-[12px] font-medium text-others-gray7 transition hover:text-others-original hover:border-others-original"
                  ...
                  <div class="px-5 md:px-20 py-10">
                      ...
                      <div v-for="(segment, segmentIndex) in bookingStore.segments" :key="segmentIndex" class="relative w-full mb-10">
                          <div class="space-x-4 md:space-x-10 text-sm md:text-base">
                          ...
                          <div v-for="(sec, i) in segment.sectors" :key="i" class="ml-5 md:ml-12">
                              <div class="grid grid-cols-12 gap-4 p-4 md:p-8">
                                  <div class="flex items-center flex-col text-xs md:text-base justify-between col-span-4 md:col-span-3">
                                  ...
                                  <div class="relative mx-2 md:mx-6">
                                  ...
                                  <div class="col-span-7 md:col-span-8 space-y-2 text-xs md:text-base">
                  ...
                  <div
                      v-if="bookingStore.selectedFare && bookingStore.selectedFare.notes && bookingStore.selectedFare.notes.length > 0"
                      class="relative bg-white md:bg-tb-body rounded-[10px] mx-4 md:mx-0 md:rounded-none drop-shadow-[0px_2px_10px_rgba(0,0,0,0.05)] md:drop-shadow-none p-4 md:p-5 mt-4 md:mt-0 md:grid md:grid-cols-12 md:gap-4 md:border-b md:border-others-gray3 last:border-b-0">
                      <!-- Cabin Title -->
                      <div class="text-others-gray1 font-bold text-lg md:col-span-3 md:text-base md:flex md:items-center md:justify-center mb-4 md:mb-0">
                          {{ bookingStore.selectedFare.cabin }}
                      </div>
                      
                      <!-- Mobile: Price section (only on mobile) -->
                      <div class="flex flex-col items-end mb-4 md:hidden">
                          <div class="flex items-end font-bold">
                              <div class="text-[12px] text-others-original pr-1">{{ currency }}</div>
                              <div class="text-[28px] text-others-original leading-none">{{ formatPrice(effectiveTotal) }}</div>
                          </div>
                      ...
                      <!-- Notes List -->
                      <ul class="space-y-2 mb-4 md:col-span-9 md:mb-0">
                      ...
                      <!-- Mobile: Bottom section with link and button -->
                      <div class="flex items-center justify-between pt-4 border-t border-others-gray3 md:hidden">
                          <button 
              ...
              <div v-if="!authStore.isAuthenticated" class="hidden md:block relative mt-[20px] bg-white rounded-[10px] drop-shadow-[0px_2px_10px_rgba(0,0,0,0.05)] px-16 py-8 w-full">
              ...
              <div class="hidden md:block relative mt-[20px] bg-white rounded-[10px] drop-shadow-[0px_2px_10px_rgba(0,0,0,0.05)] px-16 py-8 w-full">
                  ...
                  <div class="pt-8">
                      <div v-for="(p, idx) in passengers" :key="idx" class="mb-8">
                          ...
                          <div class="grid grid-cols-12 justify-between gap-x-5 items-center text-others-gray1" >
                              ...
                              <div class="relative grid-cols-12 md:col-span-3 mb-4" :class="{'pb-6': getPassengerBirthDateError(p.id)}">
              ...
              <div class="hidden md:block relative mt-[20px] bg-white rounded-[10px] drop-shadow-[0px_2px_10px_rgba(0,0,0,0.05)] px-16 py-8 w-full">
                  ...
                  <div class="grid grid-cols-12 justify-between gap-x-5 items-center text-others-gray1 pt-8">
                      ...
                      <div class="relative grid-cols-12 md:col-span-6 mb-4" :class="{ 'pb-6': phoneError }">
                      ...
                      <div class="relative grid-cols-12 md:col-span-6 mb-4" :class="{ 'pb-6': emailError }">
              ...
              <div class="hidden md:block relative mt-[20px] bg-white rounded-[10px] drop-shadow-[0px_2px_10px_rgba(0,0,0,0.05)] px-10 py-8 w-full">
          ...
          <div class="hidden md:block col-span-12 md:col-span-3 rounded-[10px] bg-white p-6 drop-shadow-[0px_2px_30px_rgba(0,0,0,0.1)] md:p-4 w-full h-fit">
              <div class="space-y-3">
                  <!-- Header total -->
...
// Watch for guest verification state changes
watch(
  () => authStore.isGuest,
  (isGuest) => {
    if (isGuest) {
      // Auto-fill contact info when guest is verified
      fillContactInfoFromAuth()
      
      // Close login dialog when guest is verified
      closeDialog()
    }
  }
)
