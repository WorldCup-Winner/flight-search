            ...
            <div class="col-span-12 md:col-span-9 w-full items-center justify-between">
                <div class="relative mt-[0px] bg-white rounded-[10px] drop-shadow-[0px_2px_10px_rgba(0,0,0,0.05)] w-full">
                    ...
                    <div
                        ...
                        class="relative grid grid-cols-12 gap-4 p-5 border-b last:border-b-0 border-others-gray3"
                        ...
                        <button class="absolute bottom-4 right-4 w-[200px] h-[40px] text-white bg-others-original rounded-[10px] text-[14px] cursor-pointer hover:bg-others-hover transition-colors" @click="openBaggageInfoAndFeeRule">行李資訊及票價規定</button>
                    </div>
                </div>
