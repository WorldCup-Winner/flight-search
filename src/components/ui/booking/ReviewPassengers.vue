    ...
    <div class="bg-white rounded-[10px] drop-shadow-[0px_2px_10px_rgba(0,0,0,0.05)] w-full max-w-2xl max-h-[90vh] overflow-y-auto">
      <div class="px-4 md:px-8 py-6 md:py-8">
        ...
        <div class="flex gap-3 md:gap-4">
          <button
            class="flex-1 px-4 py-3 border border-others-original text-others-original bg-white rounded-[10px] font-semibold hover:bg-others-original hover:text-white transition"
            @click="handleCancel"
          >
            返回修改
          </button>
          <button
            class="flex-1 px-4 py-3 bg-others-original text-white rounded-[10px] font-semibold hover:bg-others-hover transition"
            @click="handleConfirm"
          >
            確認無誤
          </button>
